...
%{
    data= load('acetaminophen.mat')
input_multem.spec_lx = data.spec_lx;
input_multem.spec_ly = data.spec_ly;
input_multem.spec_lz = data.spec_lz;
input_multem.spec_atoms = data.spec_atoms;
a= data.a
b= data.b
c= data.c
c=1
...
input_multem.spec_dz=2;
    ...
    %input_multislice.spec_lz = box(3);
...
input_multem.theta = 5.0;                        % Till ilumination (�)
input_multem.phi = 5.0;                          % Till ilumination (�)
